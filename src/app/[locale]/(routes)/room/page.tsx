...
export async function generateMetadata({ params: { locale } }: any) {
  try {
    ...
    return {
      ...
      description,
      alternates: {
        canonical: `${process.env.NEXT_PUBLIC_DOMAIN}/${locale}/room`,
        languages: {
          en: `${process.env.NEXT_PUBLIC_DOMAIN}/en/room`,
          ru: `${process.env.NEXT_PUBLIC_DOMAIN}/ru/room`,
          uz: `${process.env.NEXT_PUBLIC_DOMAIN}/uz/room`,
        },
      },
    };
  } catch (_error: any) {
